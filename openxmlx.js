...
openXmlX.ctNs = new XNamespace("http://schemas.openxmlformats.org/package/2006/content-types")
openXmlX.CT = {
    Override: new XName(openXmlX.ctNs, "Override"),
    Default: new XName(openXmlX.ctNs, "Default"),
    Types: new XName(openXmlX.ctNs, "Types"),
}

openXmlX.contentTypes = {
    ...
    macroEnabledPresentation: "application/vnd.ms-powerpoint.presentation.macroEnabled.main+xml",
    macroEnabledPresentationTemplate: "application/vnd.ms-powerpoint.template.macroEnabled.main+xml",
    macroEnabledSlideshow: "application/vnd.ms-powerpoint.slideshow.macroEnabled.main+xml",
    macroEnabledPresentationAddin: "application/vnd.ms-powerpoint.addin.macroEnabled.main+xml",
}

openXmlX.relationshipTypes = {
...
openXmlX.aNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/main");
const aNs = openXmlX.aNs;
openXmlX.A = {
...
openXmlX.a14Ns = new XNamespace("http://schemas.microsoft.com/office/drawing/2010/main");
const a14Ns = openXmlX.a14Ns;
openXmlX.A14 = {
...
const A14 = openXmlX.A14;

openXmlX.cNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/chart");
const cNs = openXmlX.cNs;
openXmlX.C = {
...
openXmlX.cdrNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/chartDrawing");
const cdrNs = openXmlX.cdrNs;
openXmlX.CDR = {
...
const CDR = openXmlX.CDR;

openXmlX.comNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/compatibility");
const comNs = openXmlX.comNs;
openXmlX.COM = {
    legacyDrawing: new XName(comNs, "legacyDrawing"),
}
const COM = openXmlX.COM;

openXmlX.cpNs = new XNamespace("http://schemas.openxmlformats.org/package/2006/metadata/core-properties");
const cpNs = openXmlX.cpNs;
openXmlX.CP = {
...
const CP = openXmlX.CP;

openXmlX.custproNs = new XNamespace("http://schemas.openxmlformats.org/officeDocument/2006/custom-properties");
const custproNs = openXmlX.custproNs;
openXmlX.CUSTPRO = {
    Properties: new XName(custproNs, "Properties"),
    property: new XName(custproNs, "property"),
}
const CUSTPRO = openXmlX.CUSTPRO;

openXmlX.dcNs = new XNamespace("http://purl.org/dc/elements/1.1/");
const dcNs = openXmlX.dcNs;
openXmlX.DC = {
...
const DC = openXmlX.DC;

openXmlX.dctermsNs = new XNamespace("http://purl.org/dc/terms/");
const dctermsNs = openXmlX.dctermsNs;
openXmlX.DCTERMS = {
    created: new XName(dctermsNs, "created"),
    modified: new XName(dctermsNs, "modified"),
}
const DCTERMS = openXmlX.DCTERMS;

openXmlX.dgmNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/diagram");
const dgmNs = openXmlX.dgmNs;
openXmlX.DGM = {
...
const DGM = openXmlX.DGM;

openXmlX.dgm14Ns = new XNamespace("http://schemas.microsoft.com/office/drawing/2010/diagram");
const dgm14Ns = openXmlX.dgm14Ns;
openXmlX.DGM14 = {
    cNvPr: new XName(dgm14Ns, "cNvPr"),
    recolorImg: new XName(dgm14Ns, "recolorImg"),
}
const DGM14 = openXmlX.DGM14;

openXmlX.digsigNs = new XNamespace("http://schemas.microsoft.com/office/2006/digsig");
const digsigNs = openXmlX.digsigNs;
openXmlX.DIGSIG = {
...
const DIGSIG = openXmlX.DIGSIG;

openXmlX.dsNs = new XNamespace("http://schemas.openxmlformats.org/officeDocument/2006/customXml");
const dsNs = openXmlX.dsNs;
openXmlX.DS = {
...
const DS = openXmlX.DS;

openXmlX.dspNs = new XNamespace("http://schemas.microsoft.com/office/drawing/2008/diagram");
const dspNs = openXmlX.dspNs;
openXmlX.DSP = {
    dataModelExt: new XName(dspNs, "dataModelExt"),
}
const DSP = openXmlX.DSP;

openXmlX.epNs = new XNamespace("http://schemas.openxmlformats.org/officeDocument/2006/extended-properties");
const epNs = openXmlX.epNs;
openXmlX.EP = {
...
const EP = openXmlX.EP;

openXmlX.lcNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/lockedCanvas");
const lcNs = openXmlX.lcNs;
openXmlX.LC = {
    lockedCanvas: new XName(lcNs, "lockedCanvas"),
}
const LC = openXmlX.LC;

openXmlX.mNs = new XNamespace("http://schemas.openxmlformats.org/officeDocument/2006/math");
const mNs = openXmlX.mNs;
openXmlX.M = {
...
openXmlX.mcNs = new XNamespace("http://schemas.openxmlformats.org/markup-compatibility/2006");
const mcNs = openXmlX.mcNs;
openXmlX.MC = {
...
const MC = openXmlX.MC;

openXmlX.mdssiNs = new XNamespace("http://schemas.openxmlformats.org/package/2006/digital-signature");
const mdssiNs = openXmlX.mdssiNs;
openXmlX.MDSSI = {
...
const MDSSI = openXmlX.MDSSI;

openXmlX.mpNs = new XNamespace("http://schemas.microsoft.com/office/mac/powerpoint/2008/main");
const mpNs = openXmlX.mpNs;
openXmlX.MP = {
    cube: new XName(mpNs, "cube"),
    flip: new XName(mpNs, "flip"),
    transition: new XName(mpNs, "transition"),
}
const MP = openXmlX.MP;

openXmlX.mvNs = new XNamespace("urn:schemas-microsoft-com:mac:vml");
const mvNs = openXmlX.mvNs;
openXmlX.MV = {
    blur: new XName(mvNs, "blur"),
    complextextbox: new XName(mvNs, "complextextbox"),
}
const MV = openXmlX.MV;

openXmlX.NoNamespace = {
    a: new XName("a"),
...
const NoNamespace = openXmlX.NoNamespace;

openXmlX.oNs = new XNamespace("urn:schemas-microsoft-com:office:office");
const oNs = openXmlX.oNs;
openXmlX.O = {
...
openXmlX.pNs = new XNamespace("http://schemas.openxmlformats.org/presentationml/2006/main");
const pNs = openXmlX.pNs;
openXmlX.P = {
...
openXmlX.p14Ns = new XNamespace("http://schemas.microsoft.com/office/powerpoint/2010/main");
const p14Ns = openXmlX.p14Ns;
openXmlX.P14 = {
...
const P14 = openXmlX.P14;

openXmlX.p15Ns = new XNamespace("http://schemas.microsoft.com/office15/powerpoint");
const p15Ns = openXmlX.p15Ns;
openXmlX.P15 = {
    extElement: new XName(p15Ns, "extElement"),
}
const P15 = openXmlX.P15;

openXmlX.picNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/picture");
const picNs = openXmlX.picNs;
openXmlX.Pic = {
...
const Pic = openXmlX.Pic;

openXmlX.rNs = new XNamespace("http://schemas.openxmlformats.org/officeDocument/2006/relationships");

const rNs = openXmlX.rNs;
openXmlX.R = {
...
openXmlX.sNs = new XNamespace("http://schemas.openxmlformats.org/spreadsheetml/2006/main");
const sNs = openXmlX.sNs;
openXmlX.S = {
...
openXmlX.slNs = new XNamespace("http://schemas.openxmlformats.org/schemaLibrary/2006/main");
const slNs = openXmlX.slNs;
openXmlX.SL = {
...
const SL = openXmlX.SL;

openXmlX.sleNs = new XNamespace("http://schemas.microsoft.com/office/drawing/2010/slicer");
const sleNs = openXmlX.sleNs;
openXmlX.SLE = {
    slicer: new XName(sleNs, "slicer"),
}
const SLE = openXmlX.SLE;

openXmlX.vmlNs = new XNamespace("urn:schemas-microsoft-com:vml");
const vmlNs = openXmlX.vmlNs;
openXmlX.VML = {
...
const VML = openXmlX.VML;

openXmlX.vtNs = new XNamespace("http://schemas.openxmlformats.org/officeDocument/2006/docPropsVTypes");
const vtNs = openXmlX.vtNs;
openXmlX.VT = {
...
const VT = openXmlX.VT;

openXmlX.wNs = new XNamespace("http://schemas.openxmlformats.org/wordprocessingml/2006/main");
const wNs = openXmlX.wNs;
openXmlX.W = {
...
openXmlX.w10Ns = new XNamespace("urn:schemas-microsoft-com:office:word");
const w10Ns = openXmlX.w10Ns;
openXmlX.W10 = {
...
const W10 = openXmlX.W10;

openXmlX.w14Ns = new XNamespace("http://schemas.microsoft.com/office/word/2010/wordml");
const w14Ns = openXmlX.w14Ns;
openXmlX.W14 = {
...
const W14 = openXmlX.W14;

openXmlX.w3digsigNs = new XNamespace("http://www.w3.org/2000/09/xmldsig#");
const w3digsigNs = openXmlX.w3digsigNs;
openXmlX.W3DIGSIG = {
...
const W3DIGSIG = openXmlX.W3DIGSIG;

openXmlX.wpNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/wordprocessingDrawing");
const wpNs = openXmlX.wpNs;
openXmlX.WP = {
...
const WP = openXmlX.WP;

openXmlX.wp14Ns = new XNamespace("http://schemas.microsoft.com/office/word/2010/wordprocessingDrawing");
const wp14Ns = openXmlX.wp14Ns;
openXmlX.WP14 = {
...
const WP14 = openXmlX.WP14;

openXmlX.wpsNs = new XNamespace("http://schemas.microsoft.com/office/word/2010/wordprocessingShape");
const wpsNs = openXmlX.wpsNs;
openXmlX.WPS = {
...
const WPS = openXmlX.WPS;

openXmlX.xNs = new XNamespace("urn:schemas-microsoft-com:office:excel");
const xNs = openXmlX.xNs;
openXmlX.X = {
...
openXmlX.xdrNs = new XNamespace("http://schemas.openxmlformats.org/drawingml/2006/spreadsheetDrawing");
const xdrNs = openXmlX.xdrNs;
openXmlX.XDR = {
...
const XDR = openXmlX.XDR;

openXmlX.xdr14Ns = new XNamespace("http://schemas.microsoft.com/office/excel/2010/spreadsheetDrawing");
const xdr14Ns = openXmlX.xdr14Ns;
openXmlX.XDR14 = {
...
const XDR14 = openXmlX.XDR14;

openXmlX.xmNs = new XNamespace("http://schemas.microsoft.com/office/excel/2006/main");
const xmNs = openXmlX.xmNs;
openXmlX.XM = {
    f: new XName(xmNs, "f"),
    _ref: new XName(xmNs, "ref"),
    sqref: new XName(xmNs, "sqref"),
}
const XM = openXmlX.XM;

openXmlX.xsiNs = new XNamespace("http://www.w3.org/2001/XMLSchema-instance");
const xsiNs = openXmlX.xsiNs;
openXmlX.XSI = {
    type: new XName(xsiNs, "type"),
}
const XSI = openXmlX.XSI;

openXmlX.ctNs = new XNamespace("http://schemas.openxmlformats.org/package/2006/content-types");
const ctNs = openXmlX.ctNs;
openXmlX.CT = {
    Override: new XName(ctNs, "Override"),
    Default: new XName(ctNs, "Default"),
    Types: new XName(ctNs, "Types"),
}
const CT = openXmlX.CT;

openXmlX.pkgRelNs = new XNamespace("http://schemas.openxmlformats.org/package/2006/relationships");
const pkgRelNs = openXmlX.pkgRelNs;
openXmlX.PKGREL = {
    Relationships: new XName(pkgRelNs, "Relationships"),
    Relationship: new XName(pkgRelNs, "Relationship"),
}
const PKGREL = openXmlX.PKGREL;

openXmlX.flatOpcPkgNs = new XNamespace("http://schemas.microsoft.com/office/2006/xmlPackage");
const flatOpcPkgNs = openXmlX.flatOpcPkgNs;
openXmlX.FLATOPC = {
...
const FLATOPC = openXmlX.FLATOPC;

module.exports = openXmlX
