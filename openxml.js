...
const OpenXML = {
  ...
  // ctNs: new XNamespace('http://schemas.openxmlformats.org/package/2006/content-types'),
  // CT: {
  //   Override: new XName(OpenXML.ctNs, 'Override'),
  //   Default: new XName(OpenXML.ctNs, 'Default'),
  //   Types: new XName(OpenXML.ctNs, 'Types')
  // }
}
